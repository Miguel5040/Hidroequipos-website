...
const Information = () => {
  ...
  return (
    <section className="px-6 pb-16 text-[#333]">
      <div className="max-w-[60rem] sm:mx-auto mt-10 mx-2">
        <div className="flex md:flex-row flex-col md:justify-between justify-center items-center md:gap-8 gap-12">
          <div className="flex flex-col text-xl gap-8">

            <div>
              <h2 className="sm:text-2xl text-xl font-base text-start text-pretty">{t("informationTitle")}</h2>
            </div>

            <div className="flex flex-row gap-5 items-center font-light text-lg">
            ...
            <div className="flex flex-row gap-5 items-center font-light text-lg">
              ...
              <span>client_services@hidroequipos.com</span>
            </div>
          ...
          <iframe
            ...
            className="border-2 border-[#1aa3c8] rounded-md w-full h-[23.125rem]"
          ></iframe>
        </div>
      </div>
    </section>
