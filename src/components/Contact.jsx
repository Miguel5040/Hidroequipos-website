    ...
    <section className="flex md:pl-6 md:px-0 px-2 md:py-8 py-6 items-center md:justify-start justify-center w-full mt-6 bg-[url('../src/assets/img/footer-alberca.webp')] bg-center bg-cover bg-no-repeat" id="contact">
      <div className="flex flex-col items-center justify-start md:w-[600px] w-full md:max-w-none max-w-[550px] p-6 bg-white rounded-lg">
        ...
        <form className="flex flex-col w-full mt-4 gap-5" onSubmit={sendEmail} id='contact-form' name='contact-form'>
          ...
          <div className="flex sm:flex-row flex-col justify-between items-center gap-5">
            <input required name='email' className="w-full border-[1px] rounded-md p-2 border-sky-700 placeholder-sky-700 placeholder:font-thin placeholder-opacity-55" type="email" placeholder={t('email')} />
            <input required name='phone' className="w-full border-[1px] rounded-md p-2 border-sky-700 placeholder-sky-700 placeholder:font-thin placeholder-opacity-55" type="phone" placeholder={t('phone')} />
          </div>
          <textarea required name='message' className="w-full border-[1px] rounded-md p-2 border-sky-700 placeholder-sky-700 placeholder:font-thin placeholder-opacity-55 resize-none h-[120px]" placeholder={t('message')} ></textarea>
