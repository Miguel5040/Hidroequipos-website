      ...
      <main className="flex flex-row lg:flex-nowrap flex-wrap gap-4 lg:mx-10 lg:items-center lg:justify-center">
        ...
        <div className="lg:w-[41.16666%] w-full lg:h-auto h-[280px] flex justify-center">
          <div className="relative w-full overflow-hidden">
            <img className="rounded-lg lg:aspect-[4/5] lg:max-h-[550px] h-full w-full object-cover object-center" src="../src/assets/img/alberca5.webp" alt="Imagen de Alberca" />
        ...
        <div className="lg:w-[29.16666%] sm:w-[calc(40%-8px)] w-full flex flex-col justify-between] relative">
          <img className="rounded-lg lg:aspect-[10/11] object-cover md:object-bottom object-center mb-2 flex-grow sm:max-h-[350px] max-h-[280px]" src="../src/assets/img/clorine.jpeg" alt="Imagen ilustrativa de probador de PH" />
